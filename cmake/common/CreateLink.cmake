...
function(CreateLink)
    ...
    if(${CMAKE_VERSION} VERSION_LESS "3.14.0") 
        ...
        file(CREATE_LINK ${Argument_TARGET} ${Argument_LINK} SYMBOLIC RESULT CreateLinkResult)
        if(CreateLinkResult)
            message(WARNING "Could not create symlink ${Argument_LINK} -> ${Argument_TARGET}: ${CreateLinkResult}. Falling back to copying the target file.")
            file(COPY_FILE ${Argument_TARGET} ${Argument_LINK})
        endif()
    endif()
